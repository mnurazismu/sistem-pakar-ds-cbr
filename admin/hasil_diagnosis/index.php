...
<head>
    ...
    <title>Hasil Diagnosis - Admin Panel</title>
...
<body class="bg-gray-50">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 md:p-8 mb-8">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Kelola dan validasi hasil diagnosis pengguna</p>
                    </div>
                </div>
                            ...
                            <tr class="bg-white border-b hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col">
                                        ...
                                        <span
                                            class="mt-1 px-2 py-1 rounded-full text-xs font-medium bg-blue-100 text-blue-800 inline-flex items-center w-fit">
                                            <i class="fas fa-percentage mr-1"></i>
                                            <?= number_format($row['ds_nilai_kepercayaan'] * 100, 1) ?>%
                                        </span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                    <div class="flex flex-col">
                                        ...
                                        <span
                                            class="mt-1 px-2 py-1 rounded-full text-xs font-medium bg-green-100 text-green-800 inline-flex items-center w-fit">
                                            <i class="fas fa-percentage mr-1"></i>
                                            <?= number_format($row['cbr_similarity'] * 100, 1) ?>%
                                        </span>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <button
                                            onclick="showValidasiModal(<?= $row['id_diagnosis'] ?>, '<?= $row['status_validasi'] ?>')"
    ...
    <script>
    // Search and filter functionality with improved UI
