...
<head>
    ...
    <title>Tambah Kasus - Admin Panel</title>
        ...
        <div class="p-4">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 md:p-8">
                <div class="flex justify-between items-center mb-8">
                    <div>
                        <h2 class="text-2xl font-semibold text-gray-800">Tambah Kasus</h2>
                        <p class="text-gray-600 mt-1">Tambahkan kasus baru ke basis pengetahuan</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2 bg-gray-50 p-4 rounded-lg">
                            ...
                            <textarea name="deskripsi_kasus" rows="4"
                                class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="Masukkan deskripsi atau penjelasan tentang kasus..."><?= isset($_POST['deskripsi_kasus']) ? htmlspecialchars($_POST['deskripsi_kasus']) : '' ?></textarea>
                        </div>
                    </div>
