...
function renderAdminSidebar($active_page) {
    ...
    $menu_items = [
        'dashboard' => [
            'url' => '/ds-cbr/admin/dashboard.php',
        ...
        'users' => [
            'url' => '/ds-cbr/admin/users/index.php',
        ...
        'gejala' => [
            'url' => '/ds-cbr/admin/gejala/index.php',
            'icon' => '<svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        'penyakit' => [
            'url' => '/ds-cbr/admin/penyakit/index.php',
            'icon' => '<svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        'pertanyaan' => [
            'url' => '/ds-cbr/admin/pertanyaan/index.php',
            'icon' => '<svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        'pilihan_jawaban' => [
            'url' => '/ds-cbr/admin/pilihan_jawaban/index.php',
            'icon' => '<svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        'rule_ds' => [
            'url' => '/ds-cbr/admin/rule_ds/index.php',
            'icon' => '<svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        'kasus' => [
            'url' => '/ds-cbr/admin/kasus/index.php',
            'icon' => '<svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        'fitur_kasus' => [
            'url' => '/ds-cbr/admin/fitur_kasus/index.php',
            'icon' => '<svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        'solusi' => [
            'url' => '/ds-cbr/admin/solusi/index.php',
            'icon' => '<svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        'hasil_diagnosis' => [
            'url' => '/ds-cbr/admin/hasil_diagnosis/index.php',
            'icon' => '<svg class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <aside id="default-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
        <div class="h-full px-3 py-4 overflow-y-auto bg-white border-r border-gray-200">
            ...
            <!-- Logout Button -->
            <div class=" bottom-0 left-0 right-0 p-3 border-t border-gray-200 bg-white">
