...
function renderUserSidebar($active_page)
{
    ...
    $menu_items = [
        'dashboard' => [
            'url' => '/sistem-pakar-ds-cbr/user/dashboard.php',
        ...
        'diagnosis' => [
            'url' => '/sistem-pakar-ds-cbr/user/diagnosis/index.php',
        ...
        'riwayat' => [
            'url' => '/sistem-pakar-ds-cbr/user/riwayat/index.php',
            'icon' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        'profil' => [
            'url' => '/sistem-pakar-ds-cbr/user/profil/index.php',
            'icon' => '<svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
